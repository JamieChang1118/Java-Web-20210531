<%-- 
    Document   : rest_book
    Created on : 2021/7/16, 下午 08:36:37
    Author     : boddy
--%>
                ...
                <table class="pure-table pure-table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${book.price}</td>
                            <td>
                                <button type="button" onclick="updateBook('${book}')" class="pure-button pure-button-primary">修改</button>
                            </td>
                            <td>
                                <button type="button" onclick="deleteBook('${book.id}')" class="pure-button pure-button-primary">刪除</button>
                            </td>
                        </tr> 
                       </c:forEach> 
                    </tbody>
