<%-- 
    Document   : bmi_session
    Created on : 2021/7/2, 下午 07:46:27
    Author     : boddy
--%>
    ...
    <body style="padding: 20px">       
        <form class="pure-form" 
            ...
            <fieldset>
                ...
                <input name="cname" type="text" placeholder="姓名" value="John"><p /> 
                ...
                <img src="http://localhost:8080/JavaWeb20210531/controller/authcode" valign="middle" /><p />
                <p />
